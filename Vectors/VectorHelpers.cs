...
//
// 		public static Vector3Int IndividualNormalized(this Vector3 vector) => new Vector3Int(vector.x.Signed(), vector.y.Signed(), vector.z.Signed());
// 		public static Vector3Int IndividualNormalized(this Vector3Int vector) => new Vector3Int(vector.x.Signed(), vector.y.Signed(), vector.z.Signed());
//
// 		/// <summary>
...
// 				where position != Vector3Int.one && position.SquaredMagnitude % 4 != 0
...
//
// 		public static Vector2Int IndividualNormalized(this Vector2 vector) => new Vector2Int(vector.x.Signed(), vector.y.Signed());
// 		public static Vector2Int IndividualNormalized(this Vector2Int vector) => new Vector2Int(vector.x.Signed(), vector.y.Signed());
//
// 		/// <summary>
// 		/// Gets the index of the largest element in this vector.
// 		/// </summary>
