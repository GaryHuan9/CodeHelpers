...
#region Operators
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator *(Int3 first, float second) => new Float3(first.x * second, first.y * second, first.z * second);
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public static Float3 operator /(Int3 first, float second) => new Float3(first.x / second, first.y / second, first.z / second);
